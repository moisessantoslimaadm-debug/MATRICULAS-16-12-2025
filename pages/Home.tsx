        ...
        <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center py-20">
          <div className="animate-in fade-in slide-in-from-left-12 duration-1000">
            <div className="inline-flex items-center gap-2 px-5 py-2 bg-white/5 border border-white/10 rounded-full mb-10 backdrop-blur-xl">
              ...
              <span className="text-indigo-200 text-[10px] font-black uppercase tracking-[0.3em]">Censo Escolar 2025 • Itaberaba Digital</span>
            </div>
            <h1 className="text-7xl md:text-9xl font-black text-white tracking-tighter leading-[0.85] mb-10">
              Futuro em <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-blue-400 to-emerald-400">Expansão.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <button
                ...
                disabled={isLoading}
                className="group relative inline-flex items-center justify-center px-12 py-6 bg-white text-slate-900 rounded-[2.5rem] font-black text-xs uppercase tracking-[0.2em] hover:bg-indigo-50 transition-all duration-500 shadow-2xl shadow-white/5 overflow-hidden active:scale-95"
              >
                {isLoading ? (
              ...
              <Link
                to="/login"
                className="inline-flex items-center justify-center px-12 py-6 bg-white/5 text-white border border-white/10 rounded-[2.5rem] font-black text-xs uppercase tracking-[0.2em] hover:bg-white/10 transition-all backdrop-blur-xl hover:border-white/20 active:scale-95"
              >
                Acesso Interno
              </Link>
            </div>
            ...
            <div className="mt-16 flex items-center gap-10 opacity-40">
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Escolas</span>
                </div>
                <div className="h-8 w-px bg-white/10"></div>
                <div className="flex flex-col">
                    <span className="text-white font-black text-2xl">12k+</span>
                    <span className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Vagas</span>
                </div>
                <div className="h-8 w-px bg-white/10"></div>
                <div className="flex flex-col">
                    <span className="text-white font-black text-2xl">24/7</span>
                    <span className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Suporte IA</span>
                </div>
            </div>
          </div>
             ...
             <div className="absolute -bottom-12 -left-12 bg-white p-10 rounded-[3.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] animate-float z-20">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Digital & Seguro</p>
                    </div>
                </div>
             </div>

             <div className="absolute -top-10 -right-10 bg-[#1E293B] p-8 rounded-[3rem] border border-white/10 shadow-2xl backdrop-blur-xl z-20 animate-float [animation-delay:2s]">
                <div className="flex items-center gap-4">
                    <div className="bg-emerald-500/20 p-3 rounded-2xl text-emerald-400">
                        <ShieldCheck className="h-6 w-6" />
                    </div>
                    <span className="text-white font-black text-sm uppercase tracking-widest">LGPD Compliance</span>
                </div>
             </div>
          </div>
        </div>
      ...
      <section className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
             <h2 className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.4em] mb-6">Inovação a Serviço da Rede</h2>
             <h3 className="text-5xl font-black text-slate-900 tracking-tighter">Infraestrutura de classe mundial <br/> para o ensino público.</h3>
          </div>
            ...
            {[
              {
                ...
                desc: "Algoritmos avançados de geolocalização garantem que seu filho estude na unidade mais eficiente para sua logística familiar.",
                color: "bg-blue-600",
              ...
              },
              {
                ...
                desc: "O 'Edu', nosso assistente cognitivo, está pronto para sanar dúvidas complexas sobre documentação e prazos em tempo real.",
                color: "bg-amber-500",
              ...
              },
              {
                ...
                desc: "Acompanhe cada etapa do processo de deferimento através do protocolo digital com rastreabilidade completa.",
      ...
      <footer className="py-20 bg-white border-t border-slate-100 mt-auto">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-10">
            <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <span className="font-black text-2xl text-slate-900 tracking-tighter uppercase">Educa<span className="text-indigo-600">Município</span></span>
            </div>
            <div className="flex items-center gap-8">
                <a href="#" className="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-[0.2em] transition">Privacidade</a>
                <a href="#" className="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-[0.2em] transition">Transparência</a>
                <a href="#" className="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-[0.2em] transition">SME Itaberaba</a>
            </div>
            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">© 2025 • Governo de Itaberaba</p>
        </div>
      </footer>
    </div>
  );
